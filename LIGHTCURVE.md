...
seamless, but there is a **deliberate discontinuity at 300 lux** — see below.
...
- **Above 300 lux (seg 1 + seg 2):** all four bulbs active — bedside, desk, overhead 1, overhead 2
- **Below 300 lux (seg 3 + seg 4):** overheads off — bedside and desk only

The overhead cutoff at 300 lux is part of the evening wind-down sequence. As lux drops through
300, the two overhead bulbs turn off and the bedside/desk lamps bump up in brightness to
...
254 |                                                        *
    |                                                  *
200 |_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _*   <- overheads OFF below here (lux descending)
    |                                                  <- seg3 ends at 200
...
- Segment 3 (10–300 lux): hyperbolic plateau crawl — evening wind-down, bedside + desk only
- Discontinuity at 300 lux: as lux drops through 300, overheads off, bri jumps 160 → 200
- Segment 2 (300–500 lux): parabolic rise — transition zone, all four bulbs
...
// Segment 3: plateau crawl (10 → 300 lux) — bedside + desk only
...
- Handling the overhead on/off logic at the 300 lux threshold (S3_LUX_HI) separately —
